function [Q,sigma,R] = FEA(r,F,E,L)
    node_coor = L.*[2 1; 2 0; 1 1; 1 0; 0 1; 0 0];%locate each node by its coordinates
    element_table = [3 5; 1 3; 4 6; 2 4; 3 4; 1 2; 4 5; 3 6; 2 3; 1 4];%Each element can be described as extending from one node to another.
